...
class ContractContract(models.Model):
    ...
    def recurring_create_invoice(self):
        ...
        """
        if not self.code:
            raise ValidationError('Debe ingresar la referencia del contrato')
    ...
    def _prepare_invoice_line(self, order_line):
        return {
            ...
            'contract_line_id': order_line.id,
        }
    ...
    def _recurring_create_invoice(self, date_ref=False):
        ...
        invoices_values[0]['contract_id'] = self.id
        invoices_values[0]['invoice_line_ids'] = [(0, None, self._prepare_invoice_line(line)) for line in self.contract_line_ids]
        del invoices_values[0]['line_ids']
